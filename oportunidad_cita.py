# -*- coding: utf-8 -*-
"""Oportunidad_cita.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/15SG7dy_w-ONZo22VsMd0QmC5ATuwolCk

# Oportunidad Cita

### Se procesan los reportes de DGH "fecha_cita.xlsx" y "oportunidad_fecha_citaBD.xlsx" generando como resultado:
...
print('-Variables')
url = "https://docs.google.com/spreadsheets/d/e/2PACX-1vRvCZOSRG38dee7qkYBCRni4RMvd448h4huADaq0DQ4ELpRi_sQqugzykpTSWD1ZLDXYUbRYNIOiITD/pub?gid=0&single=true&output=csv"
data = requests.get(url).content
dfVariables = pd.read_csv(io.StringIO(data.decode("utf-8")), dtype=str)

# Cargar df's del zip
#zip_file = zipfile.ZipFile(io.BytesIO(list(uploaded.values())[0]))
#dfFecha = pd.read_excel(zip_file.open('fecha_cita.xlsx'))
#dfOportunidad = pd.read_excel(zip_file.open('oportunidad_fecha_citaBD.xlsx'))
#dfFecha = pd.read_excel('fecha_cita.xlsx')
#dfOportunidad = pd.read_excel('oportunidad_fecha_citaBD.xlsx')
...
"""### Agregar a dfOportunidad_cita otras columnas de dfFecha"""
...
"""### Convertir 'Duracion Cita' a minutos"""
...
# Comprimir los xlsx
"""
with zipfile.ZipFile('oportunidad_cita.zip', 'w', zipfile.ZIP_DEFLATED) as xlsx_zip:
    #xlsx_zip.write('Oportunidad_cita.xlsx', dfOportunidad_cita.to_excel('Oportunidad_cita.xlsx', index=False))
    #xlsx_zip.write('FechaVacias.xlsx', dfFechaVacias.to_excel('FechaVacias.xlsx', index=False))
    #xlsx_zip.write('Oportunidad_citaVacias.xlsx', dfOportunidad_citaVacias.to_excel('Oportunidad_citaVacias.xlsx', index=False))
    xlsx_zip.write('Oportunidad_cita.xlsx')
    xlsx_zip.write('FechaVacias.xlsx')
    xlsx_zip.write('Oportunidad_citaVacias.xlsx')
    xlsx_zip.write('Oportunidad_citaTipoCitaError.xlsx')
    xlsx_zip.write('Consulta_externa.xlsx')

# Descargar el archivo oportunidad_cita.zip
files.download('oportunidad_cita.zip')
"""